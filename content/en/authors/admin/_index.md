...
<span style="color: #0cc977; font-weight: bold;">NAIG</span> focuses on developing edge-cutting theories and technologies in AI. Our team focuses on three sub-research areas: multimodal learning and reasoning, embodied intelligence for humanoid robots, and AI fundamentals and applications.

- <span style="color: #E40B07; font-weight: bold;">Multimodal Learning and Reasoning:</span> We study multimodal learning, multimodal reasoning, representation learning, foundation models, and their applications across vision, language, and other modalities. Our goal is to build intelligent systems that can understand, reason about, and interact with the multimodal world.
- <span style="color: #E40B07; font-weight: bold;">Embodied Intelligence for Humanoid Robots:</span> We aim to build a digital brain for humanoid robots, enabling them to perceive, learn, reason, make decisions, plan, and control their bodies and external objects just like humans, and finally to integrate intelligent services into daily life through robots.
...
<font color=red>**I am currently recruiting undergraduate research interns, master students (for both academic and engineering), and talented Ph.D. students (for both academic and engineering) in Fall 2026. I am also recruiting tenure-track assistant professors, assistant/associate researchers, postdocs, and engineers. If you are interested, please feel free to contact me.**</font> 
